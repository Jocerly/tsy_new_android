...
public abstract class ECCCoder {
    ...
    public static Map<String, Object> initKey() throws Exception {
        ...
        ECPoint g = new ECPoint(x1, x2); // 基点
        BigInteger n = new BigInteger("5846006549323611672814741753598448348329118574063", 10); // G的阶
    ...
    public static String encryptBASE64(byte[] key) {
        return Base64.encodeToString(key, 16);
    }
}
/**
 * 注：
