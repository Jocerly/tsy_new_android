...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckCircleOffsetX = dp2pxInt(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.SwitchButton_sb_uncheckcircle_radius,
                dp2pxInt(4));//dp2pxInt(4);

        checkedLineOffsetX = dp2pxInt(4);
        checkedLineOffsetY = dp2pxInt(4);
    ...
    private static int dp2pxInt(float dpValue) {
