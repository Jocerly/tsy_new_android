...
public class SiriWaveViewNine extends View {
	...
	private float speed;
	private int[] COLORS = { R.color.green, R.color.wave_color_1, R.color.pink };
	private int[] lightColor = { R.color.light_green, R.color.wave_color_1,
			R.color.light_pink };
	private List<SiriWave9Curve> curvesList = new ArrayList<SiriWave9Curve>();
	...
	private void init() {
		this.ratio = 1;
		this.width = this.ratio * WaveUtil.getScreenWidth(getContext());
