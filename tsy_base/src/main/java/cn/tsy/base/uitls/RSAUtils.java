...
/**
 * RSA加密解密
 * Created by Jocerly on 2018/2/28.
 */
...
public class RSAUtils {
    ...
    /**
     *
     * @param keySize 64的倍数，512-65536，推荐1024
     * @return
     */
    ...
    public static RSAPublicKey getPublicKey(String publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(Base64.decode(publicKey.getBytes()));
    ...
    public static RSAPrivateKey getPrivateKey(String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        KeyFactory keyFactory = KeyFactory.getInstance(RSA_ALGORITHM);
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(Base64.decode(privateKey.getBytes()));
    ...
    public static String privateDecrypt(String data, RSAPrivateKey privateKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, Base64.decode(data.getBytes()), privateKey.getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
    ...
    public static String publicDecrypt(String data, RSAPublicKey publicKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, Base64.decode(data.getBytes()), publicKey.getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
            throw new RuntimeException("解密字符串[" + data + "]时遇到异常", e);
        }
    }
